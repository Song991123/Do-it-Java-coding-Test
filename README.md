...
- 정렬된 배열에서 두 수의 합이 특정 값이 되는지 탐색할 때 자주 사용
- 투 포인터를 양쪽에서 시작해 가운데로 모아가며 합을 비교
- 주의할 점은, 자기 자신 (A[k]) 을 두 수 중 하나로 사용하면 안됨. -> i != k && j != k

### 🔍 2. 문제 풀이

- [백준 1253 - 나머지 합](https://www.acmicpc.net/problem/1253)
